Feature: Approve An Applicants Application
		As an Administrator, 
...
Scenario: Admin Approves a Client's Application
	...
	And I sign-up with email "Approve1@gmail.com" and password "Password1!"
	And As "Applicant", I access the loan application
	Given I input a loan of "£5000" with a yearly income of "80,000"
	Then My application is "Awaiting Decision" for an Administrator to review
	When As "Applicant", I logout of the application
	And As "Admin", I access the loan application
	When I approve  "Approve1@gmail.com" application request
	Then I expect the status of "Approve1@gmail.com" to be "Approved"